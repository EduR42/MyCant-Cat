...
<form action = "{{route('modificaCitaLar')}}" method = "POST" enctype='multipart/form-data'>
{{csrf_field()}}
...
@endif	<br>
Folio Cita <input type = 'text' class="form-control" name ='IdCita' value="{{$cita->IdCita}}" style="height:30px; max-width: 5rem;" disabled>
</div>
...
@endif	<br>
Nombre Cliente<input type = 'text' class="form-control" name = 'NombreCli' value="{{$cita->NombreCli}}" style="height:30px; max-width: 15rem;">
</div>
...
@endif	<br>
Apellidos Cliente<input type = 'text' class="form-control" name = 'ApellidosCli' value="{{$cita->ApellidosCli}}" style="height:30px; max-width: 20rem;">
</div>
...
@endif	<br>
Fecha Cita <input type = 'date' class="form-control" name = 'FechaCita' value="{{$cita->FechaCita}}" style="height:30px; max-width: 10rem;">
</div>
...
@endif	<br>
Nombre de la Mascota<input type = 'text' class="form-control" name = 'NombreMas' value="{{$cita->NombreMas}}" style="height:30px; max-width: 15rem;">
</div>
...
@endif	<br>
Motivo De La Cita <textarea name="MotivoCit" class="form-control" rows="3"style="height:120px; max-width: 20rem;">{{$cita->MotivoCit}}</textarea>
</div>
